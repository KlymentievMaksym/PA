...
# набори однакових елементiв, повнiстю вiдсортованих даних, випадкових даних, майже
# вiдсортованих, вiдсортованих в зворотному порядку, “трикутнi” (перша половина є строго
# висхiдною послiдовнiстю, а друга половина є дзеркальним вiдображенням першої) та лише
# з декiлькома рiзними значеннями всiх розмiрiв. Розмiр даних має бути з достатнього
# дiапазону, щоб побачити тенденцiю, й повинен мiстити такi, на яких можна побачити
# рiзницю. Можна взяти обмеження за часом виконання вiд 0.01с до 30с.
...
class RandomLists:
    def __init__(self, n: int, type: str, *args, **kwargs):
        self._TYPES = {'sorted': self.sorted, 'random': self.random, 'almostsorted': self.almostsorted, 'reverse': self.reverse, 'somenumbers': self.somenumbers, 'triangular': self.triangular}
...
if __name__ == '__main__':
    rng = RandomLists(10, 'triangular', start=1)
    print(rng)
